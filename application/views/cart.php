	 ...
	 <?php if($this->session->flashdata('SUCCESSMSG')) { ?>
        ...
        <?php } ?>			
		  ...
		  <tr class="cross">
			...
			<td class="t-data"> <span class="amount">Rs. <?php echo number_format($item['price'], 2); ?></span> </td>
			<td class="t-data">
                           <?php echo form_input('cart[' . $item['id'] . '][qty]', $item['qty'], 'maxlength="3" size="1" style="text-align: right"'); ?>
			</td>
                	<td class="t-data t-w3l">  <?php $grand_total = $grand_total + $item['subtotal']; ?>
                                            <span class="amount">Rs. <?php echo number_format($item['subtotal'], 2) ?></span> </td>
                        </tr>
                            <?php }?>
                             <tr>
                            ...
                            { ?>
                                <tr>
                                    <td class="product-name" colspan="100%" style="text-align: center;">
                                        <span style="font-size: 18px;"> Your Cart HASE been empty add item!!</span>
                                    </td>
                                </tr>
                           <?php }
                            ?>
