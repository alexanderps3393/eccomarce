...
<?php  require_once 'header.php';?>
    ...
    <div class="item active">
          <a><img  class="first-slide" src="<?= base_url();?>images/ba1.jpg" alt="First slide"></a>
    </div>
      ...
      {?>
        <div class="item">
            <a><img height="400px" width="100%" src="<?= base_url();?>upload/slider/<?=$slide->id?>/<?=$slide->name?>" alt="Second slide"></a>
        </div>
      <?php }
      ?>
          <!--
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
                                                                   <a class="offer-img quicklook" id="<?=$popular->id?>" style="text-align: center; cursor: pointer;">
                                                                               <img height="125px" width="100%" src="<?=base_url();?>/upload/product/<?=$popular->id;?>/<?=$popular->product_image;?>"  alt="">
									</a>
									<div class="mid-1">
										<div class="women">
										...
										<div class="mid-2">
											<p style="color: #666666;"><em class="item_price">Rs. <?=$popular->product_price?></em></p>
											  <div class="block">
											...
											<div class="add add-2">
                                                                                            ...
                                                                                            ?> 
                                                                                                <button type="submit" class="btn btn-danger my-cart-btn my-cart-b" name="action">Add to Cart</button>
                                                                                           <?php
                                                                                            echo form_close();
                                                                                        ?>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <form method="post" action="<?=base_url();?>wishlist">
                                                                                                            ...
                                                                                                            <button type="submit" class="btn btn-danger my-cart-btn my-cart-b" >Add to Wishlist</button>
                                                                                                        </form>
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
                                                                                    <p style="color: #666666;"><em class="item_price">Rs. <?=$latest->product_price?></em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											<p style="color: #666666;"><em class="item_price">Rs. <?=$feature->product_price?></em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
						...
						"<div class='modal-body modal-spa'>"+
								...
								"<div class='col-md-7 span-1'>"+
									...
									"<div class='price_single'>"+
									 " <span class='reducedfrom '>Rs. "+data.product_price+"</span>"+
									 "<div class='clearfix'></div>"+
									"</div>"+
