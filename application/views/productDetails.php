    ...
    <img height="400px" width="100%" src="<?=base_url();?>/upload/product/<?=$detail->id;?>/<?=$detail->product_image;?>" data-src="<?=base_url();?>/upload/product/<?=$detail->id;?>/<?=$detail->product_image;?>" alt="" />
			...
			<div class="col-md-7 single-top-left ">
				<div class="single-right">
				 ...
				 <div class="pr-single">
				  <p class="reduced" style="color: #666666; font-size: 16px; font-weight: 600;">Rs. <?=$detail->product_price?></p>
				</div>
					          ...
					          <?php
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
                                                                                    <p style="color: #666666;"><em class="item_price">Rs. <?=$value->product_price?></em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
